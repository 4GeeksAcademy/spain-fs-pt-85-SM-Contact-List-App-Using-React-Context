        ...
        <div className="mb-3 d-flex justify-content-center" >
            <div className="col-lg-5 d-flex justify-content-center border">
                ...
                <div className="col-md-2 d-flex justify-content-start align-items-center">
                    <button className="btn btn-outline-dark border-0 fa-solid fa-pencil mx-3"></button>
                    <button className="btn btn-outline-dark border-0 fa-solid fa-trash mx-3" onClick={props.buttonOnClick} data-bs-toggle="modal" data-bs-target="#deleteContactModal"></button>
                </div>
            </div>
        </div>
    )
